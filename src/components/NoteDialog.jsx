...
export default function NoteDialog({ open, user, currentValue, onClose, onSave, onClear }) {
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          placeholder="Notes are local and only visible to you."
          maxLength={500}
